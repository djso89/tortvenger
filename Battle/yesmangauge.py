...
class YM_Gauge(YM_Attr):
    def __init__(self):
        super().__init__()
        self.update_bar = False
        self.image_pf = pygame.image.load(ym_pf_dir).convert_alpha()
        self.image_hp = pygame.image.load(ym_hp_dir).convert()
        self.image_ki = pygame.image.load(ym_ki_dir).convert()
        self.image_kp = pygame.image.load(ym_kp_dir).convert_alpha()
        self.image_keh = pygame.image.load(ym_keh_dir).convert()
